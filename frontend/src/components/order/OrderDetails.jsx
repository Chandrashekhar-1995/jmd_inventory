...
import {useGetOrderDetailsQuery, useDeliverOrderMutation,} from "../../store/orderSlice";
          ...
          <div className="px-4">
            <div className="flex items-center justify-evenly">
              <div>
                <h3>Order Info</h3>
                <p>
                  <span className="font-bold text-slate-100">Order No:</span>{" "}
                  {order?.orderNumber}
                </p>
                <p>
            ...
            <div className="mt-6">
              ...
              <div className="px-4">
                <table
                  ...
                  hover
                  responsive
                  className="w-full text-left text-slate-300 text-lg dark:text-gray-400"
                >
                  <thead>
                    <tr>
                      <th>Product Name</th>
                  ...
                  <tbody>
                    {order?.items?.map((item) => (
                      <tr key={item._id}>
                        ...
                        <td>{item.quantity}</td>
                        <td>{item.salePrice ? item.salePrice : "0"}</td>
