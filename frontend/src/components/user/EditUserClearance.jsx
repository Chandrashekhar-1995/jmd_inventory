...
const departments = [
  "Sales","Marketing", "Finance", "Human Resource", "Administration", "Propriter", "Accounts", 
  "Company",
  "Inventory",
  "Silo",
  "Maintenance",
...
const EditUserClearance = ({ user, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg w-11/12 md:w-1/3">
